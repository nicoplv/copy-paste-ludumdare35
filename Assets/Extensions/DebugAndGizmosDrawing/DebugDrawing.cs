...
public static class DebugDrawing
{
    ...
    public static void Cylinder(Vector3 start, Vector3 end, Color color, float radius = 1, float duration = 0, bool depthTest = true)
    {
        ...
        //Radial circles
        DebugDrawing.Circle(start, up, color, radius, duration, depthTest);
        DebugDrawing.Circle(end, -up, color, radius, duration, depthTest);
        DebugDrawing.Circle((start + end) * 0.5f, up, color, radius, duration, depthTest);
    ...
    public static void Cone(Vector3 position, Vector3 direction, Color color, float angle = 45, float duration = 0, bool depthTest = true)
    {
        ...
        DebugDrawing.Circle(position + _forward, direction, color, (_forward - (slerpedVector.normalized * dist)).magnitude, duration, depthTest);
        DebugDrawing.Circle(position + (_forward * 0.5f), direction, color, ((_forward * 0.5f) - (slerpedVector.normalized * (dist * 0.5f))).magnitude, duration, depthTest);
    }
    ...
    public static void Arrow(Vector3 position, Vector3 direction, Color color, float duration = 0, bool depthTest = true)
    {
        ...
        DebugDrawing.Cone(position + direction, -direction * 0.333f, color, 15, duration, depthTest);
    }
